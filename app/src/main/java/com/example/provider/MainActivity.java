...
public class MainActivity extends ListActivity
        { final private int REQUEST_READ_CONTACTS =
                123;
        @Override
        ...
        protected void ListContacts(){
            ...
            CursorLoader cursorLoader = new CursorLoader(
                    ...
                    allContacts,
                    projection,
                    /*ContactsContract.Contacts.DISPLAY_NAME + " LIKE ?"*/null,
                    /*new String[] {"%atthoriq"}*/null,
            ...
            private void PrintContacts(Cursor c)
            {
                if (c.moveToFirst()) { do{
                    ...
                    String contactDisplayName = c.getString(c.getColumnIndex(
                            ContactsContract.Contacts.DISPLAY_NAME)); Log.v("Content Providers", contactID + ", " +
                            contactDisplayName);
//---get phone number---
                    ...
                    while (phoneCursor.moveToNext()) { Log.v("Content Providers",
